mapboxgl.accessToken = 'pk.eyJ1IjoiMHVkaW5lIiwiYSI6ImNsdmZ1Z3BwNTBiazMybW5weTI0YzBnZHkifQ.zvrWkMtWnChsFIe69mZ2Fg';
...
<strong>MO:</strong> ${point.MO}<br>
<strong>P2O5:</strong> ${point.P2O5}<br>
<strong>K2O:</strong> ${point.K2O}
`;
    });
